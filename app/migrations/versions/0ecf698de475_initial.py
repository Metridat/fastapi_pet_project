...
Revision ID: 0ecf698de475
Revises: 
Create Date: 2025-12-11 17:24:43.931549
...
def upgrade() -> None:
    ...
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('buyer_id', 'product_id', name='uq_cart_items_user_product')
    )
    ...
    sa.ForeignKeyConstraint(['product_id'], ['products.id'], ondelete='CASCADE'),
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('buyer_id', 'product_id', name='uq_reviews_buyer_product')
    )
